...
import booleanPointInPolygon from './../boolean-point-in-polygon/index';
import explode from './../explode/index';
import { collectionOf } from './../invariant/index';
import { polygon, multiPolygon, featureCollection, isObject } from './../helpers/index';
 ...
 */
export default function isobands(pointGrid, breaks, options) {
    // Optional parameters
    options = options || {};
